...
def test_transmit_courseware_task_success(fake_client, fake_catalog_client, track_selection_reverse_mock, caplog):
    ...
    enterprise_customer = EnterpriseCustomerFactory(
        catalog=1,
        name='Veridian Dynamics',
        site__domain='supersuccessful.com'
    )
    ...
    expected_dump = (
        ...
        'supersuccessful.com/course_modes/choose/course-v1:edX+DemoX+Demo_Course/",'
        ...
        'chURL": "https://supersuccessful.com/course_modes/choose/course-v1:edX+DemoX+'
